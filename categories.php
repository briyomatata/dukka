...
if(isset($_POST['add_product'])){
    ...
    $insert_query = mysqli_query($conn, "INSERT INTO `categories`(name, image) VALUES ('$p_name' ,  '$p_image') ") or die('query failed');
...
if(isset($_POST['update_product'])){
    ...
    $update_query = mysqli_query($conn, "UPDATE `products`SET name = '$update_p_name',  image = '$update_p_image' WHERE id= '$update_p_id' ");
...
<div class="container">
    <section>
        <form action="" method="post" class="add-category-form" enctype="multipart/form-data">
            ...
            <div class="inputBox">
                   <input type="submit" value="add the category" name="add_product" class="btn">
                </div>
...
<tbody>
    ...
    $select_products = mysqli_query($conn, "SELECT * FROM `categories`");
